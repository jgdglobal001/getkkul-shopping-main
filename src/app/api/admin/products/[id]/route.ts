  ...
  try {
    ...
    const updatedProduct = await prisma.product.update({
      ...
      data: {
        ...
        warrantyInformation: body.warrantyInformation !== undefined ? body.warrantyInformation : existingProduct.warrantyInformation,
        shippingInformation: body.shippingInformation !== undefined ? body.shippingInformation : existingProduct.shippingInformation,
        returnPolicy: body.returnPolicy !== undefined ? body.returnPolicy : existingProduct.returnPolicy,
        minimumOrderQuantity: body.minimumOrderQuantity !== undefined ? parseInt(body.minimumOrderQuantity) : existingProduct.minimumOrderQuantity,
