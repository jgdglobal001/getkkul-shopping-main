              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div className="flex items-center gap-2 bg-white/20 rounded-full px-4 py-2">
                    ...
                    <span className="font-semibold">{t("home.limited_time")}</span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/20 rounded-full px-4 py-2">
                    <FiPercent className="w-5 h-5" />
                    <span className="font-semibold">{t("home.up_to_off")}</span>
                  </div>
                </div>

                <h2 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">
                  🔥 {t("home.mega_sale_event").split("Event")[0]}
                  <br />
                  <span className="text-yellow-300">Event!</span>
                </h2>

                <p className="text-xl md:text-2xl mb-6 text-white/90">
                  {t("home.dont_miss_deals")}
                </p>

                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="text-center flex flex-col items-start">
                    <div className="text-3xl font-bold">100+</div>
                    <div className="text-white/80">{t("home.products_on_sale")}</div>
                  </div>
                  <div className="text-center flex flex-col items-start">
                    <div className="text-3xl font-bold">50%</div>
                    <div className="text-white/80">{t("home.max_discount")}</div>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/30">
                      ...
                      <div className="text-white/90">{t("categories.electronics")}</div>
                    </div>
                    <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/30 ml-8">
                      ...
                      <div className="text-white/90">{t("categories.fashion")}</div>
                    </div>
                    <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/30">
                      <div className="text-3xl font-bold mb-2">50% OFF</div>
                      <div className="text-white/90">{t("categories.beauty")}</div>
                    </div>
                  </div>
                </div>
              </div>
